            ...
            <div class="modal-body">
                ...
                <form action="actualizar_servidor.php?id=<?php echo $idservidor;?>" method="post">
                  ...
                  <div class="modal-footer">
                      <center><button type="submit" name="editar" class="btn color-btn-success"><span class="glyphicon glyphicon-check"></span>  ACTUALIZAR</a>
                      <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> CERRAR</button><center>
