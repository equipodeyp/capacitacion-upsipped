                                ...
                                <th style="text-align:center">DETALLES</th>
                                        ...
                                        <tbody>
                                          ...
                                          while ($var_fila=$var_resultado->fetch_array())
                                          {
                                                ...
                                                echo "<a href='#edit_".$var_fila['id']."' class='btn color-btn-success btn-sm'  data-toggle='modal'><i class='fa-solid fa-file-pen'></i> DETALLES </a>"; echo "     ";
                                                include('vercapacitacion.php');
                                                echo "</td>";
                                                echo "</tr>";
                                          }
