...
if ($verificar_no_recarga === 1) {
  ...
  $addcapacitacion = "INSERT INTO datos_capacitaciones(modalidad, tipo_capacitacion, nombre_capacitacion, tema, fecha_inicio, fecha_termino, ponente, total_horas, resultado, constancia, sede)
                         VALUES ('$modalidad_cap', '$tipo_cap', '$nombre_cap', '$tema_cap', '$fechainicio_cap', '$fechatermino_cap', '$nombre_ponente', '$dur_horas', '$resul_cap', '$constancia_cap', '$sede_cap')";
